...
export class VideoProcessor {
    ...
    constructor(video_id) {
        ...
        const ret = wasm.videoprocessor_new(ptr0, len0);
        if (ret[2]) {
    ...
    play() {
        const ret = wasm.videoprocessor_play(this.__wbg_ptr);
        if (ret[1]) {
    ...
    get_frames_processed() {
        const ret = wasm.videoprocessor_get_frames_processed(this.__wbg_ptr);
        return ret >>> 0;
    }
    process_frame() {
        const ret = wasm.videoprocessor_process_frame(this.__wbg_ptr);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_instanceof_HtmlVideoElement_a78ed95da5a8684b = function(arg0) {
        let result;
        try {
